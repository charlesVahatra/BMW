...
# Id_client, NOM, MARQUE,MODELE,VERSION, ,PRIX_ORIGINAL, KM , KM_ORIGINAL, ANNEE,MOIS,CARBURANT,BOITE, ville,CREATION_USER_ID = 1
title = []
title.append("ID_CLIENT")
title.append("ANNONCE_LINK")
title.append("PRIX")
title.append("PRIX_ORIGINAL")
title.append("NOM")
